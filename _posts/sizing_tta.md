...
The training and validation loss is quite high in 3 epochs as shown below because the model finds it harder to understand and predict the images. ![](name//media/image1.png)
...
Extract of the core idea below ![](name//media/image2.png)
